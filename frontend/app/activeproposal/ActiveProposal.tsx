            ...
            <div className="flex items-start flex-col bg-[#D5DFF2] w-[100%] -ml-4">
                ...
                <div className="w-[100%] flex flex-col">
                    <div className="flex flex-col lg:mt-[12px] mt-[18px]   gap-y-[12px]">
                        <div className="lg:h-[446px] w-[100%] border-[2px]  lg:px-[30px] lg:py-[20px] justify-between  border-[#4B82EF] p-[8px] ">
                            <div className='flex justify-between '>
                                <div className="space-x-6 flex items-center ">
                                    ...
                                    <div className="flex gap-y-[10px] flex-col">
                                        <h3 className="text-[#4B82EF] lg:text-[40px] text-[18px] font-semibold">AbdulAzeez Tasleem</h3>
